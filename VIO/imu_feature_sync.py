# from :
# https://github.com/luxonis/depthai-python/blob/main/examples/Sync/imu_video_synced.py
# https://docs.luxonis.com/projects/api/en/latest/samples/Sync/imu_video_sync/#imu-and-video-sync
# see also:
# https://docs.luxonis.com/projects/api/en/latest/components/nodes/sync_node/#sync
# derived from the imu_video_synced example.
